...
public class WebSocketStompConfig extends AbstractWebSocketMessageBrokerConfigurer {
	...
	public void configureMessageBroker(MessageBrokerRegistry registry) {
		...
		/*
		  * 如果是用自己的消息中间件，则按照下面的去配置，删除上面的配置 registry.enableStompBrokerRelay("/topic",
		 * "/queue") .setRelayHost("rabbit.someotherserver") .setRelayPort(62623)
		 * .setClientLogin("marcopolo") .setClientPasscode("letmein01");
