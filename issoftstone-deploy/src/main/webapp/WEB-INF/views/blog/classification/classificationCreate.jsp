		...
		$(function () {
			layui.use(['form', 'tree'], function () {
                ...
                form.on('submit(create-form)', function (data) {    
                	$.saveInfo({
                		url: '${ctx}/blog/classification/classificationCreateSave.json',//发送请求
				    	data: $('form').getForm(),
	...
	<div class="create-form">
        <form class="layui-form layui-form-pane">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div id="parentId" class="layui-form-select select-tree"></div>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><i></i>分类描述</label>
                <div class="layui-input-block">
