...
<hy:extends name="title">文章修改</hy:extends>
		...
		$(function () {
			layui.use(['form'], function () {
                ...
                form.on('submit(edit-form)', function (data) {
                	$.saveInfo({
                		url: '${ctx}/blog/article/articleEditUpdate.json',//发送请求
				    	data: $('form').getForm(),
                ...
                $.ajax({
			    	url: '${ctx}/blog/article/articleEditJson.json',//发送请求
			    	data: {id : '${id}'},
			    	success: function(res) {
			    		form.val("edit-form", {
		    			  	"id": res.content['id'],
		    			  	"title": res.content['title'],
		    			  	"profile": res.content['profile'],
