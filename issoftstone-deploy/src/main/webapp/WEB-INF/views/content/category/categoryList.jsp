...
<hy:extends name="javascript">
    <script type="text/javascript">
    	...
    	function deleteInfo(tableInstance, data) {
    		$.deleteInfo({
				url: '${ctx}/content/category/categoryDelete.json',//发送请求
		    	data: data,
    	...
    	layui.use(['form'], function () {
        	...
        	form.on('switch(enable)', function (data) {
				...
				$.saveInfo({
					url: '${ctx}/content/category/categoryStatusUpdate.json',
        	...
        	$("#tableList").dataTable({
                ...
                url: "${ctx}/content/category/categoryList.json",
                cols: [[
                    { type: "checkbox", fixed: "left" },
                    { field: "dictCode", title: '栏目分类编号', minWidth: 200, fixed: "left", unresize: true},
                    { field: "code",  title: "code", minWidth: 160},
                    { field: "name",  title: "name", minWidth: 160},
                    { field: "category",  title: "category", minWidth: 160},
                ...
                operate: {
                	editAction: function (tableInstance, data) {
                		$.openWindow({
							...
							height: '360px',
							width: '60%',
							url: '${ctx}/content/category/categoryEdit.do?id=' + data[0].id 
						})
					},
                ...
                groupBtn: {
                	createAction: function () {
                		$.openWindow({
							...
							height: '360px',
							width: '60%',
							url: '${ctx}/content/category/categoryCreate.do'
						})
					},
