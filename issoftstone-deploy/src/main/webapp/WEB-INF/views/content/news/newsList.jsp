...
<hy:extends name="title">新闻列表</hy:extends>
<hy:extends name="css">
	<style></style>
</hy:extends>
<hy:extends name="javascript">
    <script type="text/javascript">
    	...
    	function deleteInfo(tableInstance, data) {
    		$.deleteInfo({
				url: '${ctx}/content/news/newsDelete.json',//发送请求
		    	data: data,
		    	loadMsg: '正在删除新闻信息信息，请稍等...', 
    	...
    	layui.use(['form'], function () {
        	...
        	form.on('switch(enable)', function (data) {
				...
				$.saveInfo({
					url: '${ctx}/content/news/newsStatusUpdate.json',
        	...
        	$("#tableList").dataTable({
                ...
                url: "${ctx}/content/news/newsList.json",
                cols: [[
                    { type: "checkbox", fixed: "left" },
                    { field: "title",  title: "新闻标题", minWidth: 160},
                    { field: "author",  title: "提交人", minWidth: 160},
                    { field: "submitDate",  title: "提交时间", minWidth: 160},
                    { field: "section",  title: "分类", minWidth: 160},
                    { field: "keyWords",  title: "关键字", minWidth: 160},
                    { field: "clickTime",  title: "点击次数", minWidth: 160},
                    { fixed: "right", title: "操作", align: "center",  toolbar: "#operateBar",  width: 110, unresize: true}
                ]],
                operate: {
                	editAction: function (tableInstance, data) {
                		$.openWindow({
                			title: '<i class="layui-icon layui-icon-form"></i>&nbsp;修改新闻信息',
							height: '360px',
							width: '60%',
							url: '${ctx}/content/news/newsEdit.do?id=' + data[0].id 
						})
					},
                ...
                groupBtn: {
                	createAction: function () {
                		$.openWindow({
							title: '<i class="layui-icon layui-icon-form"></i>&nbsp;新增新闻信息',
							height: '360px',
							width: '60%',
							url: '${ctx}/content/news/newsCreate.do'
						})
					},
    ...
    <div class="grid-main">
	        ...
	        <form class="layui-form layui-form-pane" id="search-form" lay-filter="search-form">
	            <div class="layui-form-item">
				  	...
				  	<div class="layui-inline">
	                    ...
	                    <div class="layui-input-inline">
	                        <input type="text" name="section" autocomplete="off" class="layui-input">
	                    </div>
	                </div>
				  	<div class="layui-inline">
	    ...
	    <div style="display:none" class="layui-btn-container" id="tableBar">
	        <button class="	btn btn-primary radius" lay-event="createAction">
	        	<i class="Hui-iconfont Hui-iconfont-add2"></i>新增新闻
	        </button>
