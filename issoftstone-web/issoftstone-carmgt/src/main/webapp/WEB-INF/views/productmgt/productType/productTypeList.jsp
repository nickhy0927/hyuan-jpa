...
<hy:extends name="javascript">
    <script type="text/javascript">
    	...
    	function deleteInfo(tableInstance, data) {
    		$.deleteInfo({
				url: '${ctx}/productmgt/productType/productTypeDelete.json',//发送请求
		    	data: data,
		    	loadMsg: '正在删除产品类别信息信息，请稍等...', 
    	...
    	layui.use(['form'], function () {
        	...
        	form.on('switch(enable)', function (data) {
				...
				$.saveInfo({
					url: '${ctx}/productmgt/productType/productTypeStatusUpdate.json',
        	...
        	$("#tableList").dataTable({
                ...
                url: "${ctx}/productmgt/productType/productTypeList.json",
                cols: [[
                ...
                groupBtn: {
                	createAction: function () {
                		$.openWindow({
							title: '<i class="layui-icon layui-icon-form"></i>&nbsp;新增产品类别信息',
							height: '360px',
							width: '60%',
							url: '${ctx}/productmgt/productType/productTypeCreate.do'
						})
					},
    ...
    <div class="grid-main">
	    ...
	    <div style="display:none" class="layui-btn-container" id="tableBar">
	        <button class="	btn btn-primary radius" lay-event="createAction">
	        	<i class="Hui-iconfont Hui-iconfont-add2"></i>新增产品类别
	        </button>
