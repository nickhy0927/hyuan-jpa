...
<hy:extends name="title">生产周期修改</hy:extends>
		...
		$(function () {
			layui.use(['form'], function () {
                ...
                form.on('submit(edit-form)', function (data) {
                	$.saveInfo({
                		url: '${ctx}/productmgt/productPeriods/productPeriodsEditUpdate.json',//发送请求
				    	data: $('form').getForm(),
                ...
                $.ajax({
			    	url: '${ctx}/productmgt/productPeriods/productPeriodsEditJson.json',//发送请求
			    	data: {id : '${id}'},
...
<hy:extends name="body">
	<div class="create-form">
        <form class="layui-form layui-form-pane">
        	<input type="hidden" name="id" value="${productPeriods.id}">
