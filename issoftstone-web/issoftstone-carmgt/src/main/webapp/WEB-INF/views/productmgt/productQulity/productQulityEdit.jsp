...
<hy:extends name="title">产品质量修改</hy:extends>
		...
		$(function () {
			layui.use(['form'], function () {
                ...
                form.on('submit(edit-form)', function (data) {
                	$.saveInfo({
                		url: '${ctx}/productmgt/productQulity/productQulityEditUpdate.json',//发送请求
				    	data: $('form').getForm(),
                ...
                $.ajax({
			    	url: '${ctx}/productmgt/productQulity/productQulityEditJson.json',//发送请求
			    	data: {id : '${id}'},
			    	success: function(res) {
			    		form.val("edit-form", {
		    			  	"id": res.content['id'],
		    			  	"qulityType": res.content['qulityType'],
...
<hy:extends name="body">
	<div class="create-form">
        <form class="layui-form layui-form-pane">
        	<input type="hidden" name="id" value="${productQulity.id}">
