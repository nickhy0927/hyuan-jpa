...
<hy:extends name="title">出/入库理由修改</hy:extends>
		...
		$(function () {
			layui.use(['form'], function () {
                ...
                form.on('submit(edit-form)', function (data) {
                	$.saveInfo({
                		url: '${ctx}/productmgt/storeReason/storeReasonEditUpdate.json',//发送请求
				    	data: $('form').getForm(),
                ...
                $.ajax({
			    	url: '${ctx}/productmgt/storeReason/storeReasonEditJson.json',//发送请求
			    	data: {id : '${id}'},
			    	success: function(res) {
			    		form.val("edit-form", {
		    			  	"id": res.content['id'],
		    			  	"reasonType": res.content['reasonType'],
...
<hy:extends name="body">
	<div class="create-form">
        <form class="layui-form layui-form-pane">
        	<input type="hidden" name="id" value="${storeReason.id}">
