...
@TargetUrl("https://www.oschina.net/blog?classification=\\d+")
public class OschinaAllBlog {
	...
	public static void main(String[] args) {
		OOSpider.create(Site.me(), new ConsolePageModelPipeline(), OschinaAllBlog.class)
				.addUrl("https://www.oschina.net/blog").run();
	}
}
